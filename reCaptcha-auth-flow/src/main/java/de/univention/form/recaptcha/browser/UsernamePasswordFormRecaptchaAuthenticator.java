...
import de.univention.form.recaptcha.AuthenticatorUtil;
...
import static de.univention.form.recaptcha.browser.UsernamePasswordFormRecaptchaAuthenticatorFactory.G_RECAPTCHA_RESPONSE;
import static de.univention.form.recaptcha.browser.UsernamePasswordFormRecaptchaAuthenticatorFactory.SITE_KEY;
import static de.univention.form.recaptcha.browser.UsernamePasswordFormRecaptchaAuthenticatorFactory.SITE_SECRET;
...
public class UsernamePasswordFormRecaptchaAuthenticator extends UsernamePasswordForm {
    ...
    public boolean configuredFor(KeycloakSession session, RealmModel realm, UserModel user) {
        if (user == null) {
            System.out.println("Recaptcha wasn't required if no user provided.");
            return false;
        }
        return true;
    }
